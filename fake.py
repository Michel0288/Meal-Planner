...
ingredient_id=0
recipetable=2
recipe_name=['Hard tacos','Burritos','Burgers','Meatballs and rice','Sloppy Joes','Pot Roast','BBQ Ribs','French Dip Sandwiches','Calzones','Egg Rolls','Chicken Pot Pie','Enchiladas','Stuffed Green Pepers','Curry Chicken','Baked Chicken','BBQ Pigtail','Chicken Parmesan','Chicken Nuggets','Chicken Wings','Chicken Fingers','Orange Chicken','Chessy Bacon Chicken']
